...
# emlpoyee1 = Employee('Frank', 150000)
# emlpoyee1.calculate_bonus()

# employee2 = Employee('Junior', 230000)
...
# Example 1: convert temperature from celcius to fahrenheit
...
employee1 = Employee('Junior', 850000)
